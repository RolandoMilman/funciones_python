...
def promedio(numeros):
    ...
    for i in range(len_numeros):
        sumatoria += numeros[i]
        #print('Número',i, ':',numeros)

    resultado = sumatoria / len_numeros
    #print('Sumatoria de valores:', sumatoria)
    #print('Cantidad de valores:', len_numeros)
...
if __name__ == '__main__':
    ...
    # print(....)
    print('Promedio de la lista de valores:', resultado_promedio)
    print("terminamos")