...
# --------------------------------
def ordenar(numeros):
    print("Funcion ordenar lista")
    
    numeros.sort()
    
    resultado = numeros

    print("terminamos Funcion ordenar lista !")
...
if __name__ == '__main__':
    ...
    print('Lista de valores sin ordenar:', numeros)

    lista_ordenada = ordenar(numeros)

    print('Lista de valores ordenados:', lista_ordenada)
